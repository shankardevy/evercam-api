  ...
  describe 'GET /models/search' do
    ...
    context 'for an authenticated request' do
      ...
      it 'returns the model data' do
        expect(json[0]).to have_keys("id", "name", "vendor_id", "jpg_url", "mjpg_url", "h264_url", "username", "password", "shape", "resolution", "official_url", "audio_url", "more_info", "poe", "wifi", "upnp", "ptz", "infrared", "varifocal", "sd_card", "audio_io", "onvif", "psia", "discontinued", "defaults")
      end
